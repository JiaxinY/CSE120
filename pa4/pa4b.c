 ...
 * given the file mykernel4.c, which contains a rudimentary thread package
 ...
 * from 0 to MAXTHREADS-1, where MAXTHREADS is defined in mykernel4.h).
 *
 ...
 * understand how it interacts with the code in mykernel4.c  Experiment
